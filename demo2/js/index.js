...
/******/ 	var hotCurrentHash = "2fd881a8b00c6338379e"; // eslint-disable-line no-unused-vars
...
//json-loader
var stu = __webpack_require__(0);

var txt = 'my first name is ' + stu.name;

$("#app").html("<h1>郭胜华傅秀萍!</h1>" + txt + "<br/>");
//amd加载方式局部加载需要时加载
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function (stujson) {
    console.log(stujson);
    return $("#app").append(txt);
